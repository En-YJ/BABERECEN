...
namespace BABERECEN.Dialogs
{
    public class MainDialog : ComponentDialog
    {
        ...
        private async Task<DialogTurnResult> ActStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            var key = "86b028669ad341cabf470efa587648a8";

            // YOUR-ENDPOINT: example is westus2.api.cognitive.microsoft.com
            var endpoint = "https://westus.api.cognitive.microsoft.com/luis/api/v2.0";

            // //public sample app
            var appId = "e02fffa5-4d00-4919-bdc2-9f77a4ce5c9f";
            ...
            //var endpointUri = String.Format("https://{0}/apps/{1}/slots/production/predict?query={2}", endpoint, appId, queryString);

            var response = await client.GetAsync(endpointUri);

            var strResponseContent = await response.Content.ReadAsStringAsync();
            var getWeatherMessage = MessageFactory.Text(strResponseContent, strResponseContent, InputHints.IgnoringInput);
